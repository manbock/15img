...
document.querySelector("#chainn").addEventListener("mouseover",function(){
...
document.querySelector("#aty").addEventListener("mouseover",function(){
   this.style.color="rgb(177,177,177)";
...
document.querySelector("#mic").addEventListener("mouseover",function(){
   this.style.color="rgb(177,177,177)";
...
document.querySelector("#tapso").addEventListener("mouseover",function(){
   this.style.color="rgb(177,177,177)";
